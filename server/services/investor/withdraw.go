...
// Withdraw: Admin → Investor (money leaves the system)
// → Decreases Investor.Balance and Admin.Balance
type WithdrawInfo = TransactionInfoStruct

func (InvestorStruct) Withdraw(info WithdrawInfo) (*models.Transaction, error) {
