...
// Deposit: Investor → Admin (money moves to the system)
// → Increases Investor.Balance and Admin.Balance
...
func (InvestorStruct) Deposit(info DepositInfo) (*models.Transaction, error) {
